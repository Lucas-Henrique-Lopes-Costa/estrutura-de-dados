/*
Questão 4: Pilha com encadeamento - Inventário de itens de jogo - limite superior
Implemente uma função que realize a remoção dos jogos com valores superiores a um valor informado, denominada remoção especial. Você poderá utilizar
somente
...
x: seguido de um inteiro: para remover (e imprimir) todos os elementos com valor superior ao informado
Saídas:
