/*
Questão 9: Fila - Atendimento copiadora (v2)
...
uso
de fila. Você deverá usar uma estrutura de dados do tipo
fila
, sendo que a classe fila não deve conter nenhum método que tenha características do problema. Em outras palavras, a classe fila não pode ter mecanismos indevidos de acessos a seus dados. Também não é permitido o uso da STL ou similares.
