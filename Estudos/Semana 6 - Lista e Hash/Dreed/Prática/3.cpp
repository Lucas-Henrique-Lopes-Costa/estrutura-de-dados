/*
Questão 1: Lista Simplesmente Encadeada - Equipes de Maratona - Tamanho da lista
Implemente uma função que realize a contabilidade dos elementos de uma lista simplesmente encadeada. Para esta atividade você
não
poderá utilizar a variável tamanho, ou qualquer outra que contabilize o número de elementos na lista, na sua estrutura. Ou seja, a verificação do tamanho deverá ser feita contando os elementos da lista. Caso a lista não possua elementos imprima
0
.
Você pode (
e deve!
