...
Entradas:
Quantidade de linhas e colunas (dois número inteiros positivos).
Elementos presentes na matriz (números inteiros).
Elemento a ser procurado na matriz (número inteiro).
Saídas:
