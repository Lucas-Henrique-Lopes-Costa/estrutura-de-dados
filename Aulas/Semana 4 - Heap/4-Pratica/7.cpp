/*
Questão 7: Torneio - Torneio residual - Segundo lugar
...
A entrada deve conter o número de participantes seguido dos participantes. A saída apresenta o valor base do participante vice-campeão do torneio.
Entradas:
Quantidade de participantes
Identificação dos participantes
Saídas:
Valor base do vice-campeão do torneio
Exemplo de Entrada:
8
2 7 4 1 3 9 6 8
Exemplo de Saída:
